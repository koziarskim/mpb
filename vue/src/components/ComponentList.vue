  ...
  data() {
    return {
      ...
      availableUnitFilters: [
        {id: "EXTRA_DESC", name: "Extra \u21E9"},
        {id: "EXTRA_ASC", name: "Extra \u21E7"},
        {id: "PEN_REC_DESC", name: "Pen Rec \u21E9"},
        {id: "PEN_REC_ASC", name: "Pen Rec \u21E7"},
        {id: "STOCK_DESC", name: "Stock \u21E9"},
        {id: "STOCK_ASC", name: "Stock \u21E7"},
        {id: "FLOOR_DESC", name: "Floor \u21E9"},
        {id: "FLOOR_ASC", name: "Floor \u21E7"},
      ],
      unitFilter: {},
