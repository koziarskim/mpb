...
public class ComponentDto {
	...
	public ComponentDto(Long id, String number, String name, Long unitsNeeded, int unitsOnStock, Long units, Long unitsReceived, Long unitsInTransit, BigDecimal unitPrice, boolean selected) {
		this.id = id;
		this.number = number;
		this.name = name;
		this.unitsNeeded = unitsNeeded;
		this.unitsOnStock = Long.valueOf(unitsOnStock);
